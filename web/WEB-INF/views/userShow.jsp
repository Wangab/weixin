...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/page_mp_article_improve2a26bd.css">
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/page_mp_article_improve_combo29ab01.css">
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/appmsg/not_in_mm2637ae.css">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="format-detection" content="telephone=no">
    <title>【WeStar模特卡】${nick}/身高:<fmt:formatNumber type="number" maxFractionDigits="3"
                                                   value="${height}"/>cm/体重:<fmt:formatNumber type="number"
                                                                                              maxFractionDigits="3"
                                                                                              value="${weight}"/>kg</title>
    <!--
    /三围:0-0-0/脚码:0
     -->
    ...
    <div class="rich_media_inner">
        <div id="page-content">
            <div id="img-content" class="rich_media_area_primary">
                <h2 class="rich_media_title" id="activity-name">【WeStar模特卡】${nick}</h2>
                <div class="rich_media_meta_list">
                    <em id="post-date" class="rich_media_meta rich_media_meta_text">
                        <% out.println(new SimpleDateFormat("yyyy-MM-dd").format(new Date()) + " "); %><a
                            href='http://www.tpy10.net/create.php?id=WeStarBL'>WeStar公众账号</a>&nbsp;<strong>北京</strong>&nbsp;阅读 ${num}
                    </em>
                </div>
                            ...
                            <section
                                ...
                                <section
                                    ...
                                    <section class="135brush"
                                        ...
                                        <br>
                                        <p style="text-align: right;"><b>登录名：${name}</b></p>
                                        <p style="text-align: right;"><b>所在城市：${haunted}</b></p>
                                        <p style="text-align: right;"><b>三围：<fmt:formatNumber type="number" maxFractionDigits="3" value="${bust}"/> - <fmt:formatNumber type="number" maxFractionDigits="3" value="${waist}"/> - <fmt:formatNumber type="number" maxFractionDigits="3" value="${hips}"/></b></p>
                                        <p style="text-align: right;"><b>身高：<fmt:formatNumber type="number" maxFractionDigits="3" value="${height}"/> cm</b></p>
                                        <p style="text-align: right;"><b>体重：<fmt:formatNumber type="number" maxFractionDigits="3" value="${weight}"/> kg</b></p>
                                        <!-- <p style="text-align: right;"><b>胸围：0.0</b></p>
                                        <p style="text-align: right;"><b>臀围：0.0</b></p>
                                        <p style="text-align: right;"><b>腰围：0.0</b></p>
                                        <p style="text-align: right;"><b>脚码：0</b></p> -->
                                    </section>
                                </section>
                            </section>
                        </section>
